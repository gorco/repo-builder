...
public class Monejos extends RepoLibraryBuilder {
    ...
    protected void doBuild() {
        ...
        repoEntity("Monejo", "Monejo", "A beautiful simple animated character",
                ...
                .tagFullyAnimatedCharacter().frameState(2, d, WALK, RIGHT,
                "Monejo2 andando_10", "Monejo2 andando_04");
        ...
        repoEntity(
                ...
                "Animación de un ratón de ordenador haciend click izquierdo y derecho",
        ...
        repoEntity("Blue cap monejo", "Monejo con gorra azul",
                ...
                "bluecap.png", null).tagAnimatedCharacter().tag("blue cap",
                "gorra azul");
